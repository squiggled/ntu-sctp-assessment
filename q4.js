...
class Child extends Parent {
    ...
    addNewAbilities(newAbility){
        return this.abilities.push(newAbility);
    }
}

const c = new Child();
c.addNewAbilities("Dancing"); //og code was 'c.addNewAbility("Dancing")', which didn't match up to the code provided in the qn above
